...
export async function POST() {
  try {
    ...
    await prisma.user.createMany({
      data: [
        { name: "Administrador", email: "admin@hotel.com", password: adminPassword, role: "admin", hotelId: hotel.id },
        { name: "Recepcionista", email: "recepcion@hotel.com", password: recepPassword, role: "receptionist", hotelId: hotel.id },
      ],
    });
