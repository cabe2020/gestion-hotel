...
export default function SignUpPage() {
  ...
  const updateHotel = (key: string, value: string) => setHotelForm((p) => ({ ...p, [key]: value }));

  const updateAdmin = (key: string, value: string) => setAdminForm((p) => ({ ...p, [key]: value }));
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error?.[0]?.message || data.error || 'Error al crear la cuenta');
        setLoading(false);
        return;
      }
        ...
        <div className="relative z-10 flex flex-col justify-between px-14 py-12 w-full">
          ...
          <div>
            ...
            <p className="text-blue-200 text-lg leading-relaxed max-w-md">
              Crea tu cuenta en minutos y accede a todas las herramientas que necesitas para
              administrar tu hotel.
            </p>
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
          <div className="w-full max-w-lg">
            ...
            <div className="mb-6">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Crear mi cuenta de hotel</h1>
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className={`h-8 w-8 rounded-full flex items-center justify-center text-xs font-bold transition-colors ${
                        step >= s.n ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-400'
                      }`}
                    >
            ...
            {step === 2 && (
              <div className="space-y-5">
                <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-2">
                  <p className="text-xs text-blue-700 font-medium">Cuenta de administrador</p>
                  <p className="text-xs text-blue-600 mt-1">
                    Esta será tu cuenta principal con acceso completo al sistema. Podrás crear
                    usuarios adicionales después.
                  </p>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
                  <p className="text-xs text-amber-800">
                    Al crear tu cuenta, podrás configurar tipos de habitación, agregar más usuarios
                    y personalizar tu hotel desde la sección de Configuración.
                  </p>
                </div>
